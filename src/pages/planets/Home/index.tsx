    ...
    return (
        <FeatureTemplate>
            <FeatureTemplate.Hero
                ...
                quote={QUOTES.robertSherwood.quote}
                author={QUOTES.robertSherwood.author}
            />
            <FeatureTemplate.StickyBarSections
                text="Select Topic"
                tab={props.match.params.tab}
                options={PLANET_DROPDOWN_OPTIONS}
                onChange={onChange}
            />
                ...
                <Container>
                    ...
                    <Row>
                        ...
                        <Col sm="12" md="7" className={`${styles.why_8_wrapper} p-4`}>
                            ...
                            <p className={`${styles.main_text} mt-3 p-0`}>
                                This can be a touchy subject and lead to heated debates, Offically, there are 8 planets.
                                The <span style={{fontWeight: 800}}>IAU</span> <i>(International Astronomical Union)</i>{' '}
                                removed Pluto from the list of what had been nine planets in the Solar System in August
                                2006, due to not meeting the{' '}
                                <a
                                    target="_blank"
                                    rel="noreferrer"
                    ...
                    <div className="rounded overflow-hidden shadow-sm mt-5 bg-dark text-light p-4">
                        ...
                        <div className="p-3">
                            ...
                            <p className={`${styles.sub_text} p-0`}>
                                2 - Has sufficient mass for its self-gravity to overcome rigid body forces so that it
                    ...
                    <ul>
                        <li className="ml-n2">
                            <p className={`${styles.main_text}`}>
                                <strong>Mercury’s</strong> craters are named after famous artists, musicians and
                                authors.
                            </p>
                        </li>
                        ...
                        <li className="ml-n2 mt-3">
                            <p className={`${styles.main_text}`}>
                                <strong>Earth’s</strong> atmosphere protects us from meteoroids and radiation from the
                                Sun.
                            </p>
                        </li>
                    </ul>
