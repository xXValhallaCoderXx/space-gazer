...
const MercuryTab = () => {
  return (
    <>
      <Row>
        <Col sm="12" md="8">
          <p style={{fontSize: 30, fontWeight: 800}}>Solar Eclipse</p>
          <p>
            A solar eclipse is a natural event that takes place on Earth when
            the Moon moves in its orbit between Earth and the Sun (this is also
            known as an occultation). It happens at New Moon, when the Sun and
            Moon are in conjunction with each other. If the Moon was only
            slightly closer to Earth, and orbited in the same plane and its
            orbit was circular, we would see eclipses each month.
            <br />
            <br />
            The lunar orbit is elliptical and tilted with respect to Earth’s
            orbit, so we can only see up to 5 eclipses per year. Depending on
            the geometry of the Sun, Moon and Earth, the Sun can be totally
