    ...
    <Container>
      <Row>
        <Col sm="12" className="p-4">
          ...
          <p className={`${styles.main_text} mt-3 p-0`}>
            There are <strong>8</strong> <i>(not 9?)</i> planets in our solar
            system, they are{" "}
            <i>
      ...
      <Row>
        ...
        <Col sm="12" md="7" className={`${styles.why_8_wrapper} p-4`}>
          ...
          <p className={`${styles.main_text} mt-3 p-0`}>
            This can be a touchy subject and lead to heated debates, Offically,
            there are 8 planets. The <span style={{fontWeight: 800}}>IAU</span>{" "}
            <i>(International Astronomical Union)</i> removed Pluto from the
            list of what had been nine planets in the Solar System in August
      ...
      <div className="rounded overflow-hidden shadow-sm mt-5 bg-dark text-light p-4">
        <h3 className={`${styles.sub_title} p-0 pl-3`}>
        ...
        <div className="p-3">
          ...
          <p className={`${styles.sub_text} p-0`}>
            2 - Has sufficient mass for its self-gravity to overcome rigid body
