                        ...
                        <Col>
                            <ul className={styles.home_facts_ul}>
                                <li className="mt-3">
                                    ...
                                    dwarf planets, <Link to="/solar-system/3">moons</Link>, and numerous smaller objects
                                ...
                                <li className="mt-3">
                                    <strong>99.86%</strong> of the solar system’s mass is found in the Sun. The majority
                                    of the remaining <strong>0.14%</strong> is contained within the eight planets.
                                </li>
                                <li className="mt-3">
                                ...
                                <li className="mt-3">
                                    ...
                                    <Link to="/solar-system/2">“terrestrial planets”</Link>, are primarily composed of
                                    rock and metal.
                                </li>
                                <li className="mt-3">
                                    The four outer planets, also known as the{' '}
                                    <Link to="/solar-system/2">"gas giants”</Link>, are substantially larger and more
