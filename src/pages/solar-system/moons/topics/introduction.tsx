            ...
            <Row>
                <Col sm="12">
                    ...
                    <p className={`${styles.main_text} mt-3`}>
                        We get to see this wonder, each night, but do you ever take a moment, to stop, and realize to
                        stare up, and realize all the amazing energy surrounding us?
                    </p>
                </Col>
            </Row>
            <p>
                There are more than 194 moons of the various planets, dwarf planets in the solar system. The planets
                Mercury and Venus do not have any moons and neither does the dwarf planet Ceres. Find out the number of
                moons each planet has and their names below.
            </p>
            <p className="mt-5">
