                        ...
                        <Col sm="9">
                            <div>
                                <p className={styles.intro_text}>
                                    ...
                                    <strong> beauty of the universe</strong> that we live in this very moment, from
                                    trying to comprehend its sheer size, to the wonders of how it came to be.
                                </p>
                                <p className={styles.intro_text}>
                                    The size of the Earth may seem vast to us, but in reality, it does not even compare
                                    to a grain of sand, in a universe that is estimated to contain over 200 billion
                                    galaxies. This is something to think about, the next time we take our lives too
                                    seriously.
                                </p>
                                <p className={styles.intro_text}>
                                    ...
                                    universe is so vast, and the number of galaxies, starts planets in it, surely there
                                    must be other sentient life our there, But....Why havent we heard from them?
                                </p>
                            </div>
                        </Col>
