        ...
        <Col>
          <ul className={styles.home_facts_ul}>
            <li className="mt-3">
              ...
              <Link to="/solar-system/3">moons</Link>, and numerous smaller
            ...
            <li className="mt-3">
              ...
              Sun. The majority of the remaining <strong>0.14%</strong> is
              contained within the eight planets.
            </li>
            <li className="mt-3">
            ...
            <li className="mt-3">
              ...
              <Link to="/solar-system/2">“terrestrial planets”</Link>, are
