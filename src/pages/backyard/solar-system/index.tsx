...
import SolarSystem from './topics/introduction';
                ...
                <div className={styles.title_wrapper}>
                    <Bounce>
                        ...
                        <p className={styles.title_caption}>
                            We all live in our own world. But if you look up at the starry sky - you'll see that all the
                            different worlds up there combine to form constellations, solar systems and galaxies.
                        </p>
