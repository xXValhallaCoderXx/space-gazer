        ...
        <Container>
            ...
            <Col sm="12" md="6">
              <div className={styles.intro_text_wrapper}>
                <p className={styles.main_text}>
                  I have always had a keen interest in space, though it wasnt over the recent few years my passion for
                  it increasingly grew.
                  <br />
                  <br />
                  The more I discovered about all its mysteries, and facts, the further it drove my curiosity to learn
                  more.
                </p>
              </div>
            </Col>
          ...
          <Row style={{marginTop: 150}}>
            ...
            <Col md="6">
              ...
              <p className={styles.icon_text_right}>
                I was searching around for Space infomational websites for the younger generation, and found most of
                them to be quite bland or difficult to navigate. This is what set the notion to create this concept
                website.
              </p>
            </Col>
          </Row>
          <Row style={{marginTop: 150, marginBottom: 150}}>
            <Col md="6" className="order-2 order-sm-1">
              ...
              <p className={styles.icon_text_left}>
                To be an infomational Space website for a younger audience, with hopes of increasing awareness, and
                spark curiosity in others, inspiring them to start to look upon the stars.
              </p>
            </Col>
          ...
          <Row style={{marginTop: 150, marginBottom: 150}}>
            ...
            <Col md="6">
              ...
              <p className={styles.icon_text_right}>
                If this site sparks the curiosity of just one person to look towards the stars, then this website has
                fufilled its duty.
              </p>
            </Col>
          </Row>
